...
export default function Beranda() {
  ...
  const getCardPath = (title: string) => {
    switch (title) {
      case "IT Seminar": return "/seminar";
      case "IT Talkshow": return "/talkshow";
      case "IT Competition": return "/competition";
      case "IT Workshop": return "/workshop";
      default: return "/";
    }
  };
    ...
    <div style={{ backgroundColor: "#FFFFFF" }}>
        ...
        buttons={[
          {
            ...
            variant: "primary",
            onClick: () => {
              const el = document.getElementById("tentang-invofest");
              ...
              <Card key={index}>
                ...
                <div style={{ marginTop: "auto" }}>
                  <Button
                    label="INFO SELENGKAPNYA"
                    variant="primary"
                    onClick={() => navigate(getCardPath(item.title))}
                  />
                </div>
              </Card>
            ))}
      ...
      <section style={{ position: "relative", padding: "140px 0", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: 1200, margin: "0 auto", padding: "0 24px" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 64 }}>
            <div style={{ flex: "0 0 400px" }}>
              <img src="https://www.invofest-harkatnegeri.com/assets/Maskot-Lomba.png" alt="Mascot Competition" style={{ width: "100%", height: "auto" }} />
            </div>
            <div style={{ flex: 1 }}>
